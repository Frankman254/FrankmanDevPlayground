	...
	if (locale === "en") {
		return [
			...
			},
			{
				...
				title: "QR Generator",
				description:
					"Create share-ready QR codes with a center icon, optional caption styling and high-resolution PNG export.",
	...
	return [
		...
		},
		{
		...
		},
			{
				...
				title: "Generador QR",
				description:
					"Crea codigos QR listos para compartir con icono central, titulo opcional estilizado y exportacion PNG en alta resolucion.",
				href: "/experiments/qr-generator",
				category: "experiment",
				status: "live",
				iconName: "QrCode",
