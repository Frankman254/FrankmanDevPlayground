...
export const translations = {
	es: {
		...
		chess: {
			...
			fullscreenUnsupported: "Pantalla completa no disponible en este navegador.",
		},
		qrGeneratorPage: {
			eyebrow: "Experimentos",
			title: "Generador de codigo QR",
			description:
				"Crea codigos QR con icono central (logo Playground por defecto), titulo opcional estilizado y descarga en PNG alta resolucion.",
		},
		liveWallpaperExperimentPage: {
			...
			previewHint: "Vista previa no incrustada: muchos sitios bloquean iframes. Usa el boton para abrir la demo.",
		},
		...
		qrGenerator: {
			eyebrow: "Herramienta",
			title: "Generador de codigo QR",
			description: "Escribe el contenido o enlace, elige un icono central y descarga el QR final en PNG.",
			calloutTitle: "Hecho para Playground",
			calloutBody:
				"Exporta PNG en alta resolucion con hueco e icono ajustables. El logo por defecto es el brand mark del playground.",
			contentLabel: "Contenido o enlace",
			...
			qrSizeHint: "La descarga se escala a alta resolucion; los PNG con transparencia funcionan como icono.",
			iconSize: "Tamano del icono",
			iconSizeShort: "Icono",
			iconSizeHint: "Tamano visual del icono dentro del hueco.",
			holeSize: "Tamano del hueco QR",
			holeShort: "Hueco",
			holeHint: "Tamano del recorte blanco en el centro, independiente del icono.",
			posX: "Posicion X",
			posY: "Posicion Y",
			resetLayout: "Resetear",
			preview: "Vista previa",
			emptyTitle: "El QR aparecera aqui",
			emptyBody: "Agrega un enlace o texto para generar la vista previa.",
			download: "Descargar PNG",
			downloadSuccess: "QR descargado en alta resolucion.",
			customize: "Personalizar QR",
			notesTitle: "Notas",
			notesBody:
				"Puedes usar enlaces, texto o datos vCard. Comprueba el escaneo con el telefono antes de imprimir.",
			errors: {
				canvas: "No se pudo preparar la descarga.",
				blob: "No se pudo generar el PNG.",
				image: "No se pudo convertir el QR a imagen.",
			},
			icons: {
				none: "Sin icono",
	...
	en: {
		...
		qrGeneratorPage: {
			...
			description:
				"Create QR codes with a center icon (Playground logo by default), optional styled caption, and high-resolution PNG export.",
		},
		liveWallpaperExperimentPage: {
			eyebrow: "Experiments",
			title: "Live Wallpaper Anime Glitch",
			...
			previewHint: "No embedded preview: many sites block iframes. Use the button to open the demo.",
		},
		skateDeckExperimentPage: {
			eyebrow: "Experiments",
			title: "Skate Deck Studio",
		...
		qrGenerator: {
			eyebrow: "Utility",
			title: "QR code generator",
			description: "Enter a URL or text, pick a center icon, and download the final QR as PNG.",
			calloutTitle: "Built for Playground",
			calloutBody:
				"Export a high-resolution PNG with adjustable hole and icon. The default mark is the playground brand icon.",
			contentLabel: "Content or URL",
			...
			qrSize: "QR size",
			qrSizeHint: "Export is scaled up; transparent PNGs work well as the center icon.",
			iconSize: "Icon size",
			iconSizeShort: "Icon",
			iconSizeHint: "Visual size of the icon inside the hole.",
			holeSize: "QR hole size",
			holeShort: "Hole",
			holeHint: "Size of the white cut-out in the center, independent from the icon.",
			posX: "Position X",
			posY: "Position Y",
			resetLayout: "Reset",
			preview: "Preview",
			emptyTitle: "Your QR will appear here",
			emptyBody: "Add a link or text to generate a preview.",
			download: "Download PNG",
			downloadSuccess: "QR downloaded at high resolution.",
			customize: "Customize QR",
			notesTitle: "Notes",
			notesBody: "Use links, plain text or vCard data. Scan with a phone before printing.",
			errors: {
				canvas: "Could not prepare the download.",
				blob: "Could not generate the PNG.",
				image: "Could not rasterize the QR.",
			},
			icons: {
				none: "No icon",
